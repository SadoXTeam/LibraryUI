...
local OrionLib = {
	...
	Themes = {
		Default = {
			...
			Stroke = Color3.fromRGB(251, 255, 124),
			Divider = Color3.fromRGB(60, 60, 60),
			Text = Color3.fromRGB(251, 255, 124),
			TextDark = Color3.fromRGB(251, 255, 124)
		}
	},
...
local Success, Response = pcall(function()
	Icons = HttpService:JSONDecode(game:HttpGetAsync("https://raw.githubusercontent.com/SadoXTeam/LibraryUI/refs/heads/main/akfwahifi.json")).icons
end)
...
CreateElement("Label", function(Text, TextSize, Transparency)
	local Label = Create("TextLabel", {
		Text = Text or "",
		TextColor3 = Color3.fromRGB(251, 255, 124),
...
function OrionLib:MakeNotification(NotificationConfig)
	spawn(function()
		...
		local NotificationFrame = SetChildren(SetProps(MakeElement("RoundFrame", Color3.fromRGB(25, 25, 24), 0, 10), {
			...
			MakeElement("Stroke", Color3.fromRGB(251, 255, 124), 1.2),
			MakeElement("Padding", 12, 12, 12, 12),
			SetProps(MakeElement("Image", NotificationConfig.Image), {
				Size = UDim2.new(0, 20, 0, 20),
				ImageColor3 = Color3.fromRGB(251, 255, 124),
				Name = "Icon"
			}),
